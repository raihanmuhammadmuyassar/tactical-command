...
const items = [
  {
    ...
    desc: "Subjects employ counter-surveillance, signal masking, and pattern variation to defeat conventional tracking.",
    metric: "+312%",
    metricLabel: "evasion attempts / 2024",
  },
  {
    id: "02",
    title: "Signal Denial",
    desc: "GPS jamming, GSM blackouts, and RF spoofing render most commercial tracking platforms inert in the field.",
    metric: "8 of 10",
  ...
  },
  {
    ...
    desc: "Fragmented data sources produce blind windows. Decisions are made on partial pictures, hours after the event.",
    metric: "47 min",
